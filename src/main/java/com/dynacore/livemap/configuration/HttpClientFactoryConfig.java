...
public class HttpClientFactoryConfig {
  ...
  public HttpClient autoConfigHttpClient(
      String URL) { // Todo: move inside ChannelHandlers and dynamically switch on runtime...
    ...
    switch (capability) {
      case DEFAULT:
        ...
        break;
      case ETAG:
        client = etagClient(URL);
        break; // etagClient(URL);  break;
      default:
  ...
  public ServerCapability getServerCapability(
    ...
    return HttpClient.create()
        ...
        .responseSingle(
            (HttpClientResponse metaResp, ByteBufMono ignoredContents) -> {
  ...
  public HttpClient defaultClient(String URL) {
    return HttpClient.create().baseUrl(URL).port(80);
  }
    ...
    return HttpClient.create()
        ...
        .doOnRequest(
            (req, conn) -> {
              ...
              conn.addHandlerLast(
                  "netty.left.httpobjectaggregator", new HttpObjectAggregator(1048576));
